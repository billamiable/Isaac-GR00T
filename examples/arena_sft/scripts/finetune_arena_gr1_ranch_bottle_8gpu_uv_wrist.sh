#!/usr/bin/env bash
# GR1 ranch-bottle GR00T N1.6 SFT (ego + wrist views, absolute arms and hands).
#
...
MODALITY_CONFIG_PATH="${MODALITY_CONFIG_PATH:-${ARENA_SFT_ROOT}/configs/gr1_arms_only_wrist_data_config.py}"
NUM_GPUS="${NUM_GPUS:-8}"
